...
mongo_obj = MongoDBUtility(app_configuration.MONGO_DATABASE, app_configuration.MONGO_COLLECTION)
...
class UserManagement:
    ...
    def add_user(self, request_data):
        ...
        try:
            ...
            if data:
                ...
                status = mongo_obj.insert_record(request_data)
                if status:
    ...
    def login_user(self, request_data):
        ...
        try:
            ...
            data = mongo_obj.fetch_records(mongo_query)
            if data:
                mongo_data = data[0]
            ...
            inactive_user_data = mongo_obj.fetch_records(user_inactive_query)
            ...
            mongo_user_data = mongo_obj.fetch_records(user_data)
            if mongo_user_data:
    ...
    def delete_user(self, request_data):
        ...
        try:
            ...
            mongo_obj.delete_records(mongo_operation)
            json_object['status'] = 'success'
